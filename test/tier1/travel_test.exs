defmodule Merlin.TravelTest do
  ...
  This is not hypothetical. A phone went flat at a workshop at the evening, its owner
  drove home, and at three minutes after that the intruder latch fired on him opening his own
